...
export function InteractiveHoverButton({
  ...
  return (
    ...
    >
      ...
      <div
        className="text-primary-foreground absolute top-0 z-10 flex h-full w-full translate-x-12 items-center justify-center gap-2 opacity-0 transition-all duration-700 group-hover:-translate-x-5 group-hover:opacity-100">
        <span>{children}</span>
      </div>
    </button>
  );
